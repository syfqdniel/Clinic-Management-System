...
<body> 
    <div class="container">
        <center><h1>Stock Report</h1></center>  
    
    <form method="get" action="pharmacyStockReport.jsp" method = "get">
    ...
    <%
        ...
        try {
            ...
            String querySelectStock = "SELECT stockMedication_id, stockMedication_medicationCode, stockMedication_Quantity " 
                                          + "FROM StockMedication ";
                
                
                
           ResultSet StockRecord = statement.executeQuery(querySelectStock); 
          
                out.println("<br><b>Medication Report</b>");
                out.println("<table>"); 
                out.println("<tr>" +
                                "<th>Stock ID</th>" +
                ...
                while (StockRecord.next()) {
                
                    String stockID = StockRecord.getString("stockMedication_id"); 
                    String stockMedCode = StockRecord.getString("stockMedication_medicationCode"); 
                    String stockQuantity = StockRecord.getString("stockMedication_Quantity"); 
