...
<script>
        ...
        function validate2(){
            ...
            let Phone = document.forms["ProfileUpdateForm"]["employeePhone1"].value;
            let Add = document.forms["ProfileUpdateForm"]["employeeAddress1"].value;
...
<body>
    <div class="container">
        ...
        <form name="ProfileUpdateForm" action="pharmacyUpdateProfileProcess.jsp" method="post">
        <%   
            if (employeeName != null) {
                try { 
