...
<body>
    <div class="container">
        ...
        <form name="ChangePassword" action="clerkChangePasswordInsert.jsp" method="post">
        <%   
            if (LoginId != null) {
                try { 
        ...
        %> 
                ...
                <b>Employee ID:  <%= loginID %></b><br> 
        <table>  
            <tr>          
            <br><td><b>Current Password:</b></td>  
            ...
            <tr>
                ...
                <td><input type="password" name="employeePass3" value="<%= Password %>" class="rcorners1"><br></td>
                            ...
                            <!-- button submit--> 
                            <br><input type="submit" name="update" value="Update" onclick="return validate2()" class="my-button"> 
                        </form>
        <% 
                    } else {
